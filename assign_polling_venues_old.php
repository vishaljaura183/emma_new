...
{
	//print_r($_POST); die;
	$polling_site_id = $_POST['polling_site_id'];
	...
	$supply_needed = implode(',',$_POST['supply_needed']);
	 ...
	 $sql = "INSERT INTO service_tickets SET 
			...
			technician_id='$technician_id', address='$address', 
		...
		<div class="box-content service_ticket_left">
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="control-group">
								...
								<div class="controls">
								  <select id="polling_site_id" name="polling_site_id" onchange="preview_ticket();" required>
								  <option value='' >Select</option>
									<?php foreach($get_poll_venues as $venues){ ?>
									<option value="<?php echo $venues['id']; ?>" rel="<?php echo $venues['location_nm'].'-'.$venues['address']; ?>"><?php echo $venues['name_of_location']; ?></option>
					  ...
					  <div class="control-group hidden-phone">
						  ...
						  <div class="controls">
							<textarea class="cleditor2" id="poll_addr"  rows="3" name = 'address' onkeyup="preview_ticket();"></textarea>
						  </div>
						</div>
						<div class="control-group hidden-phone">
						  <label class="control-label" for="textarea2">Reason Of Call</label>
						  <div class="controls">
								  <select id="call_reason" name="call_reason[]" onchange="preview_ticket();" multiple>
					...
					<div class="control-group">
								...
								<div class="controls">
								  <select id="supply_needed" name="supply_needed[]" onchange="preview_ticket();" multiple>
...
$('#polling_site_id :selected').each(function(i, selected){ 
	var poll_addr = $("#polling_site_id :selected").attr("rel");
	
	$("#poll_addr").val(poll_addr);

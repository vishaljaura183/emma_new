...
{
	$address = $_POST['address_line_1'].' '.$_POST['address_line_2'].', '.$_POST['ST'].' '.$_POST['ZIP'];
		...
		<div class="box-content">
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label" for="focusedInput">ADA_accessible</label>
						<div class="controls">
					...
					<div class="control-group">
						...
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['municipality']?>" name = 'municipality'>
						</div>
					 </div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">ward</label>
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['ward']?>" name = 'ward'>
						</div>
					 </div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">precinct</label>
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['precinct']?>" name = 'precinct'>
						</div>
					 </div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">name_of_location</label>
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['name_of_location']?>" name = 'name_of_location'>
						</div>
					 </div>
					<div class="control-group">
					...
					<div class="control-group">
						<label class="control-label" for="focusedInput">address_line_1</label>
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['address_line_1']?>" name = 'address_line_1'>
						</div>
					 </div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">address_line_2</label>
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['address_line_2']?>" name = 'address_line_2'>
						</div>
					 </div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">post_office</label>
						<div class="controls">
					...
					<div class="control-group">
						...
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['ST']?>" name = 'ST'>
						</div>
					 </div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">ZIP</label>
						<div class="controls">
						  <input class="input-xlarge" id="" type="text" value="<?php echo @$results_arr[0]['ZIP']?>" name = 'ZIP'>
						</div>
					 </div>
